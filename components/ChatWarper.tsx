...
//       <div className="w-full max-w-xl mx-auto h-[65vh] rounded-b-3xl bg-transparent bg-gray-100 flex flex-col">
//         {/* Messages container */}
...
//           <div className="w-full h-[65vh] border-green-500 border-2">
...
//             className="border-red-500 h-[50vh]  border-2 flex-1 flex flex-col justify-end overflow-y-auto pt-12 scrollbar-thin custom-scrollbar"
//           >
//             {messages?.length > 0 ? (
...
//             )}
//             {error && <Message content={error.message} isUserMessage={false} />}
//           </div>
//           </div>
//         </div>
//         {/* Input container */}
...
// initialMessages,
{
  ...
  return (
    <div className="w-[95vw] h-[65vh] mx-auto md:mx-0 md:w-screen relative">
      <div className="w-full max-w-xl mx-auto h-[65vh] rounded-b-3xl bg-transparent bg-gray-100 flex flex-col">
        {/* Messages container */}
        <div className="flex-1 bg-gray-100 overflow-hidden relative">
          <div className="absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-white via-gray-100/50 to-transparent pointer-events-none z-10" />
          ...
          <div
            ref={containerRef}
            id="messages-container"
            className="pt-12 flex flex-col overflow-y-auto h-full scrollbar-thin custom-scrollbar"
            // className="h-full flex flex-col justify-end overflow-y-auto pt-12 scrollbar-thin custom-scrollbar"
          >
            {messages?.length > 0 ? (
            ...
            {status === "submitted" && <Message content="..." isLoading={true} isUserMessage={false} />}
            {error && <Message content={error.message} isUserMessage={false} />}
          </div>
        </div>
        {/* Input container */}
